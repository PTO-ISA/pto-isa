...
Standalone reference page for `pto.tmin`. This page belongs to the [Elementwise Tile Tile](../../elementwise-tile-tile.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.tmul](./tmul.md)
- Next op in instruction set: [pto.tmax](./tmax.md)
