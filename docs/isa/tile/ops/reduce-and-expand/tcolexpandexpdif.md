...
Standalone reference page for `pto.tcolexpandexpdif`. This page belongs to the [Reduce And Expand](../../reduce-and-expand.md) instruction set in the PTO ISA manual.
