...
This compatibility page points to the canonical tile-instruction reference page for [pto.trowexpandexpdif](./tile/ops/reduce-and-expand/trowexpandexpdif.md).
