...
Standalone reference page for `pto.plt_b8`. This page belongs to the [Predicate Generation And Algebra](../../predicate-generation-and-algebra.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.pge_b32](./pge-b32.md)
- Next op in instruction set: [pto.plt_b16](./plt-b16.md)
