...
This compatibility page points to the canonical tile-instruction reference page for [pto.tset_img2col_padding](./tile/ops/sync-and-config/tset-img2col-padding.md).
