...
Standalone reference page for `pto.tnot`. This page belongs to the [Elementwise Tile Tile](../../elementwise-tile-tile.md) instruction set in the PTO ISA manual.
...
- Next op in instruction set: [pto.trelu](./trelu.md)
