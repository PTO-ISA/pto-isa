...
template void LaunchTMaxs<float, NUM_64, NUM_64, NUM_64, NUM_64>(float *out, float *src, float *scalar, void *stream);
template void LaunchTMaxs<int32_t, NUM_64, NUM_64, NUM_64, NUM_64>(int32_t *out, int32_t *src, int32_t *scalar,
                                                                   void *stream);
template void LaunchTMaxs<aclFloat16, NUM_16, NUM_256, NUM_16, NUM_256>(aclFloat16 *out, aclFloat16 *src,
