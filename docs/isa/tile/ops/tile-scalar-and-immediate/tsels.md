...
Standalone reference page for `pto.tsels`. This page belongs to the [Tile Scalar And Immediate](../../tile-scalar-and-immediate.md) instruction set in the PTO ISA manual.
