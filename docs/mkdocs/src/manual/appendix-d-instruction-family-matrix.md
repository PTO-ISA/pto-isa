...
| Memory (GM <-> Tile) | 6 |
| Matrix Multiply | 8 |
| Data Movement / Layout | 16 |
| Complex | 18 |
| Total | 127 |

## D.3 Header synchronization status

- Header inventory source: `include/pto/common/pto_instr.hpp` (125 unique instruction APIs)
- Manifest inventory source: `docs/isa/manifest.yaml` (127 entries)
- Missing in manifest: none
- Present in manifest but missing in header: TSETHF32MODE, TSETTF32MODE
...
| Manual / Resource Binding | `TSET_IMG2COL_RPT` | `config` | `config, state` | `docs/isa/TSET_IMG2COL_RPT.md` |
| Manual / Resource Binding | `TSET_IMG2COL_PADDING` | `config` | `config, state` | `docs/isa/TSET_IMG2COL_PADDING.md` |
...
| Tile-Scalar / Tile-Immediate | `TAXPY` | `scalar` | `dst, src, scalar` | `docs/isa/TAXPY.md` |
...
| Axis Reduce / Expand | `TROWPROD` | `reduce_expand` | `dst, src, tmp` | `docs/isa/TROWPROD.md` |
...
| Data Movement / Layout | `TALIAS` | `reshape_move` | `original, alias` | `docs/isa/TALIAS.md` |
| Data Movement / Layout | `TSUBVIEW` | `reshape_move` | `dst, src, row, col` | `docs/isa/TSUBVIEW.md` |
| Data Movement / Layout | `TCONCAT` | `reshape_move` | `dst, src0, src1` | `docs/isa/TCONCAT.md` |
| Data Movement / Layout | `TTRANS` | `reshape_move` | `dst, src` | `docs/isa/TTRANS.md` |
| Data Movement / Layout | `TPACK` | `reshape_move` | `dst, src` | `docs/isa/TPACK.md` |
...
| Complex | `TDEQUANT` | `complex` | `dst, src, scale, offset` | `docs/isa/TDEQUANT.md` |
| Complex | `TPUSH` | `complex` | `producer, tile, fifo` | `docs/isa/TPUSH.md` |
| Complex | `TPOP` | `complex` | `consumer, tile, fifo` | `docs/isa/TPOP.md` |
| Complex | `TFREE` | `complex` | `pipe` | `docs/isa/TFREE.md` |
