...
- 头文件清单来源：`include/pto/common/pto_instr.hpp`（125 个唯一指令 API）
- Manifest 清单来源：`docs/isa/manifest.yaml`（127 条目）
- 头文件有但 manifest 缺失：无
- manifest 有但头文件缺失：TSETHF32MODE, TSETTF32MODE
...
| 手动 / 资源绑定 | `TSET_IMG2COL_RPT` | `config` | `config, state` | `docs/isa/TSET_IMG2COL_RPT_zh.md` |
| 手动 / 资源绑定 | `TSET_IMG2COL_PADDING` | `config` | `config, state` | `docs/isa/TSET_IMG2COL_PADDING_zh.md` |
...
| Tile-标量 / Tile-立即数 | `TAXPY` | `scalar` | `dst, src, scalar` | `docs/isa/TAXPY_zh.md` |
...
| 轴归约 / 扩展 | `TROWPROD` | `reduce_expand` | `dst, src, tmp` | `docs/isa/TROWPROD_zh.md` |
...
| 数据搬运 / 布局 | `TALIAS` | `reshape_move` | `original, alias` | `docs/isa/TALIAS_zh.md` |
| 数据搬运 / 布局 | `TSUBVIEW` | `reshape_move` | `dst, src, row, col` | `docs/isa/TSUBVIEW_zh.md` |
| 数据搬运 / 布局 | `TCONCAT` | `reshape_move` | `dst, src0, src1` | `docs/isa/TCONCAT_zh.md` |
| 数据搬运 / 布局 | `TTRANS` | `reshape_move` | `dst, src` | `docs/isa/TTRANS_zh.md` |
| 数据搬运 / 布局 | `TPACK` | `reshape_move` | `dst, src` | `docs/isa/TPACK_zh.md` |
...
| 复杂指令 | `TDEQUANT` | `complex` | `dst, src, scale, offset` | `docs/isa/TDEQUANT_zh.md` |
| 复杂指令 | `TPUSH` | `complex` | `producer, tile, fifo` | `docs/isa/TPUSH_zh.md` |
| 复杂指令 | `TPOP` | `complex` | `consumer, tile, fifo` | `docs/isa/TPOP_zh.md` |
| 复杂指令 | `TFREE` | `complex` | `pipe` | `docs/isa/TFREE_zh.md` |
