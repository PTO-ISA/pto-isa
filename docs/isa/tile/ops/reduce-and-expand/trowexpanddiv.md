...
Standalone reference page for `pto.trowexpanddiv`. This page belongs to the [Reduce And Expand](../../reduce-and-expand.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.trowexpand](./trowexpand.md)
