...
Standalone reference page for `pto.tmatmul`. This page belongs to the [Matrix And Matrix Vector](../../matrix-and-matrix-vector.md) instruction set in the PTO ISA manual.
