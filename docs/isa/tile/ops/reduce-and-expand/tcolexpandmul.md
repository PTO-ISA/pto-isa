...
Standalone reference page for `pto.tcolexpandmul`. This page belongs to the [Reduce And Expand](../../reduce-and-expand.md) instruction set in the PTO ISA manual.
...
- Next op in instruction set: [pto.tcolexpandadd](./tcolexpandadd.md)
