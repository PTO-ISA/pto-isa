...
Standalone reference page for `pto.tstore`. This page belongs to the [Memory And Data Movement](../../memory-and-data-movement.md) instruction set in the PTO ISA manual.
