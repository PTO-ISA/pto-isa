...
Standalone reference page for `pto.vbcnt`. This page belongs to the [Unary Vector Instructions](../../unary-vector-ops.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.vnot](./vnot.md)
- Next op in instruction set: [pto.vcls](./vcls.md)
