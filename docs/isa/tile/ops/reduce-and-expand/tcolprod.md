...
Standalone reference page for `pto.tcolprod`. This page belongs to the [Reduce And Expand](../../reduce-and-expand.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.tcolsum](./tcolsum.md)
- Next op in instruction set: [pto.tcolmax](./tcolmax.md)
