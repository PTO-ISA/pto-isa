...
This compatibility page points to the canonical tile-instruction reference page for [pto.tcolexpandexpdif](./tile/ops/reduce-and-expand/tcolexpandexpdif.md).
