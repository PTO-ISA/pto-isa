...
Standalone reference page for `pto.tadds`. This page belongs to the [Tile Scalar And Immediate](../../tile-scalar-and-immediate.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.tmins](./tmins.md)
- Next op in instruction set: [pto.tsubs](./tsubs.md)
