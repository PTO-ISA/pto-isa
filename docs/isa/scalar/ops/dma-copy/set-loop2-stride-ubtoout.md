...
Standalone reference page for `pto.set_loop2_stride_ubtoout`. This page belongs to the [DMA Copy](../../dma-copy.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.set_loop_size_ubtoout](./set-loop-size-ubtoout.md)
- Next op in instruction set: [pto.set_loop1_stride_ubtoout](./set-loop1-stride-ubtoout.md)
