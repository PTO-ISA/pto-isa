...
Standalone reference page for `pto.trecip`. This page belongs to the [Elementwise Tile Tile](../../elementwise-tile-tile.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.tlog](./tlog.md)
- Next op in instruction set: [pto.tprelu](./tprelu.md)
