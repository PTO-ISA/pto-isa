...
Standalone reference page for `pto.tshl`. This page belongs to the [Elementwise Tile Tile](../../elementwise-tile-tile.md) instruction set in the PTO ISA manual.
...
- Previous op in instruction set: [pto.tdiv](./tdiv.md)
- Next op in instruction set: [pto.tshr](./tshr.md)
